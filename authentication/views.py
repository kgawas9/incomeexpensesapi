...
from authentication.serializer import RegisterSerializer, EmailVerificationSerializer, LoginSerializer, ResetPasswordEmailRequestSerializer, SetNewPasswordSerializer
...
class RegisterView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        data = {
            ...
            'email_subject':'Verify django account'
        }
...
class VerifyEmail(views.APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response({
                'email':'User successfully activated'
...
class PasswordTokeCheckAPIView(generics.GenericAPIView):
